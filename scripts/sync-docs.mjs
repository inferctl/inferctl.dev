...
const pages = [
  ...
  ['comparisons/inference-control-plane-landscape', 'comparisons/inference-control-plane-landscape.md', 'Inference Control-Plane Landscape', 'Compare local inference runtimes, request gateways, and inferctl as an out-of-band control plane.', 'concepts', 10],
  ['comparisons/inferctl-vs-openclaw-infer', 'comparisons/inferctl-vs-openclaw-infer.md', 'inferctl and OpenClaw Infer', 'Compare inferctl readiness and route planning with OpenClaw inference request execution.', 'concepts', 20],
  ['comparisons/openclaw-preparation-pipeline-assessment', 'comparisons/openclaw-preparation-pipeline-assessment.md', 'OpenClaw Preparation Pipeline Assessment', 'Review the OpenClaw request-preparation pipeline and its boundary with inferctl.', 'concepts', 30],
  ['comparisons/inferctl-vs-inferflux', 'comparisons/inferctl-vs-inferflux.md', 'inferctl and InferFlux', 'Compare inferctl local readiness planning with the InferFlux inference server and gateway.', 'concepts', 40],
  ['comparisons/inferctl-vs-localai', 'comparisons/inferctl-vs-localai.md', 'inferctl and LocalAI', 'Compare inferctl route planning with LocalAI model serving, routing, and runtime operations.', 'concepts', 50],
  ['comparisons/inferctl-vs-llama-swap', 'comparisons/inferctl-vs-llama-swap.md', 'inferctl and llama-swap', 'Compare inferctl route planning with llama-swap request proxying and model-process lifecycle control.', 'concepts', 60],
  ['comparisons/inferctl-vs-litellm-proxy', 'comparisons/inferctl-vs-litellm-proxy.md', 'inferctl and LiteLLM Proxy', 'Compare inferctl local route planning with LiteLLM Proxy request routing and provider policy.', 'concepts', 70],
  ['comparisons/inferctl-vs-llamacpp-router', 'comparisons/inferctl-vs-llamacpp-router.md', 'inferctl and llama.cpp server router', 'Compare inferctl route planning with llama.cpp server router request forwarding and local model lifecycle control.', 'concepts', 80],
  ['comparisons/inferctl-vs-otari', 'comparisons/inferctl-vs-otari.md', 'inferctl and Otari', 'Compare inferctl local route planning with Otari gateway routing, budget enforcement, and provider policy.', 'concepts', 90],
  ['comparisons/inferctl-vs-bifrost', 'comparisons/inferctl-vs-bifrost.md', 'inferctl and Bifrost', 'Compare inferctl local route planning with Bifrost provider gateway routing, failover, and observability.', 'concepts', 100],
  ['comparisons/inferctl-vs-nvidia-dynamo', 'comparisons/inferctl-vs-nvidia-dynamo.md', 'inferctl and NVIDIA Dynamo', 'Compare inferctl local route planning with NVIDIA Dynamo distributed inference serving and KV-aware routing.', 'concepts', 110],
  ['comparisons/inferctl-vs-llmd-router-kserve', 'comparisons/inferctl-vs-llmd-router-kserve.md', 'inferctl, llm-d Router, and KServe', 'Compare inferctl local route planning with llm-d Router request placement and KServe Kubernetes model deployment.', 'concepts', 120],
  ['comparisons/inferctl-vs-ray-serve-llm', 'comparisons/inferctl-vs-ray-serve-llm.md', 'inferctl and Ray Serve LLM', 'Compare inferctl local route planning with Ray Serve LLM distributed model deployment and replica routing.', 'concepts', 130],
  ['comparisons/inferctl-vs-sglang-model-gateway', 'comparisons/inferctl-vs-sglang-model-gateway.md', 'inferctl and SGLang Model Gateway', 'Compare inferctl local route planning with SGLang Model Gateway request routing, worker lifecycle, and gateway policy.', 'concepts', 140],
